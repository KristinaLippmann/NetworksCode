...
%% PowerSpectralDensity (Welch)
    ...
    results.RelGammaPower(:,1)=results.Power_analysis(:,9);
    results.RelLowGammaPower(:,1)=results.Power_analysis(:,10);
    results.RelMidGammaPower(:,1)=results.Power_analysis(:,11);
...
parfor k=1:subphases
    ...
    results.RelGammaPowerPhase(:,:)=results.PowerPhase_analysis(:,:,9);
    results.RelLowGammaPowerPhase(:,:)=results.PowerPhase_analysis(:,:,10);
    results.RelMidGammaPowerPhase(:,:)=results.PowerPhase_analysis(:,:,11);
...
%% aligning data 4 export
    ...
    if lastbin_cut==1
        ...
        results.RelGammaPower((numberofbins+lastbin_cut),1)=results.Power_analysis((numberofbins+lastbin_cut),9);
        results.RelLowGammaPower((numberofbins+lastbin_cut),1)=results.Power_analysis((numberofbins+lastbin_cut),10);
        results.RelMidGammaPower((numberofbins+lastbin_cut),1)=results.Power_analysis((numberofbins+lastbin_cut),11);
...
FreqRelGammaPowerphasename='FreqGammaPower_ts ';
FreqRelLowGammaPowerphasename='FreqLowGammaPower_ts ';
FreqRelMidGammaPowerphasename='FreqMidGammaPower_ts ';
...
for i=1:length(info.phaselength)
    ...
    FreqRelGammaPowerphasename(end:end)=num2str(i);
    FreqRelLowGammaPowerphasename(end:end)=num2str(i);
    FreqRelMidGammaPowerphasename(end:end)=num2str(i);
        ...
        results.(FreqRelGammaPowerphasename)=results.RelGammaPower(sum(min2bin(1:i-1))+1:sum(min2bin(1:i)),1);
        results.(FreqRelLowGammaPowerphasename)=results.RelLowGammaPower(sum(min2bin(1:i-1))+1:sum(min2bin(1:i)),1);
        results.(FreqRelMidGammaPowerphasename)=results.RelMidGammaPower(sum(min2bin(1:i-1))+1:sum(min2bin(1:i)),1);
        
%    end
end

clear TAUphasename Freqphasename FreqPowerphasename FreqWidthphasename FreqAreaphasename FreqSignal2Neighbourname FreqRelGammaPowerphasename FreqRelLowGammaPowerphasename FreqRelMidGammaPowerphasename i who2take
