...
if isempty(getenv('CEDS64ML'))
    setenv('CEDS64ML', 'C:\Users\janolli\Dropbox\science\olebox\matson\CEDS64ML');
end
...
% Open a file
fhand1 = CEDS64Open( 'D:\data\tetrodes\cultures\160804 - D3Sl1-2 - 2x tetrodes and 2x LFP baseline physo +ach washout units nice.smr' );
if (fhand1 <= 0); unloadlibrary ceds64int; return; end

% get waveform data from channel 1
[ fRead, fVals, fTime ] = CEDS64ReadWaveF( fhand1, 1, 10000000, 0 );
