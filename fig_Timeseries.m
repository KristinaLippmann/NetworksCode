function timeseries_figure=fig_Timeseries(wavelet_Xaxis, wavelet_Yaxis, waveletdata,... & wavelet
                        Xaxis, Frequency, Power, FWatHM, Area, TAU,... % LFP GammaPower
...
% Create ylabel
%str = sprintf('Power [mV^{%.3g}/Hz] x 10^{%.3g}',2,power_digits*-1); %% original: 
text('String','Relative gamma power [HZ]',...
    'Parent',Power_axes,...
    'Units', 'normalized',...
    'Position',[-0.055 0.5 0],...
    'HorizontalAlignment','center',...
...
% Create title
title('Relative gamma power (30-100 Hz)',...
    'Units', 'normalized',...
    'Position',[0.5 1.025 0],...
    'HorizontalAlignment','center',...
    'VerticalAlignment','bottom',...
