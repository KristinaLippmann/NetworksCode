...
%                     currentfile.results.Signal2NeighbourPhase(ii:length(currentfile.info.phaselength):end);
                ...
                copypaste.median.RelGammaPower(i,ii)=...
                    nanmedian(currentfile.results.RelGammaPowerPhase(ii:length(currentfile.info.phaselength):end));
                
                copypaste.median.RelLowGammaPower(i,ii)=...
                    nanmedian(currentfile.results.RelLowGammaPowerPhase(ii:length(currentfile.info.phaselength):end));
                
                copypaste.median.RelMidGammaPower(i,ii)=...
                    nanmedian(currentfile.results.RelMidGammaPowerPhase(ii:length(currentfile.info.phaselength):end));
